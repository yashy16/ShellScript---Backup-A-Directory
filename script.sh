...
directory_to_backup="/home/root5/DirectoryToBackup" # this is the directory we want to zip and create a backup 

backup_location="/home/root5/"	# This is the path we want to store the Backup
